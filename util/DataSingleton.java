...
public class DataSingleton {
  ...
  *************************************************************** */
    public void setEnquadramento(int enquadramento){
      ...
      /* ***************************************************************
  * Metodo: getErro
  * Funcao: Retornar o que foi escolhido no choicebox para escolha do erro
  * Parametros: Nao recebe
  * Retorno: inteiro
  *************************************************************** */
    public int getErro(){
 ...
 /* ***************************************************************
  * Metodo: setErro
  * Funcao: Passa o parametro do index do choice box para a variavel que armazena o erro
  * Parametros: Nao recebe
  * Retorno: inteiro
  *************************************************************** */
